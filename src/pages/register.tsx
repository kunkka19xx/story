        ...
        <div className="flex flex-col-reverse md:flex-row min-h-full">
          ...
          <div className="w-full md:w-1/2 min-h-full items-center">
            ...
            <form action="" className="">
              ...
              <div className="relative mt-8 mb-4 mx-auto w-5/6">
                <input
                  type="text"
                  id="id-input-email"
                  className="rounded-lg peer h-10 w-full border border-lime-800 focus:outline-none focus:border-t-white focus:border-indigo-500"
              ...
              <div className="relative mt-6 mb-4 mx-auto w-5/6">
                <button className="bg-green-100 hover:bg-indigo-300 hover:font-semibold h-9 hover:border-indigo-500 border border-lime-800 rounded-xl w-full text-center">
                  <a href="/register">Register</a>
                </button>
              </div>

              <div className="relative mt-2 mb-2 mx-auto w-5/6">
                <a
                  href="/login"
                  type="button"
                  target="_blank"
