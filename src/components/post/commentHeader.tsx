...
function CommentHeader() {
  ...
  return (
    <section className="">
      {/* author infor */}
      <div id="id-comment-header-" className="flex flex-row items-center mb-2">
        <div className="rounded-full overflow-hidden w-8 h-8">
          <img src="/assets/avatar/avatar.jpeg" alt="" className="" />
        </div>
        <div id="id-comment-author" className="ml-3 flex items-center">
          <div className="">
            <span className="mr-2 inline-block">{author}</span>
            <button
              onClick={handleClick}
